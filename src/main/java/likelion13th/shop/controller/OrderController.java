...
public class OrderController {
    ...
    public ApiResponse<?> createOrder(
        ...
        OrderResponseDto newOrder = orderService.createOrder(request, customUserDetails.getUser());
    ...
    public ApiResponse<?> getAllOrders(
        ...
        List<OrderResponseDto> orders = orderService.getAllOrders(customUserDetails.getUser());
